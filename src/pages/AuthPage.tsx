      ...
      <div className="w-full max-w-md space-y-8">
        <div className="text-center space-y-2">
          ...
          <p className="text-muted-foreground text-sm">
            {mode === "signup" ? "Join the waitlist for early access" : "Welcome back, hungry one"}
          </p>
        </div>
        ...
        <div className="bg-card border border-border rounded-xl p-6 space-y-5">
          ...
          <div className="space-y-2.5">
            <button className="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-lg border border-input bg-background text-sm font-medium text-foreground hover:bg-muted transition-colors">
          ...
          <div className="space-y-3">
            ...
            <Button className="w-full gradient-primary text-primary-foreground font-semibold">
              ...
              {mode === "signup" ? "Get Early Access" : "Sign In"}
            </Button>
          </div>
